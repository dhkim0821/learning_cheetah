...
class MinitaurExtendedEnv(MinitaurReactiveEnv):
  ...
  def _get_observation(self):
    ...
    if self._include_leg_model:
      ...
      leg_model = MinitaurExtendedEnv.convert_to_leg_model(raw_motor_angles)
  ...
  def _termination(self):
    ...
    leg_model = MinitaurExtendedEnv.convert_to_leg_model(self.minitaur.GetMotorAngles())
    swing0 = leg_model[0]
    swing1 = leg_model[2]
    maximum_swing_angle = 30.0 / 180.0 * np.pi
  ...
  def reward(self):
    ...
    reward -= 0.001 * action_acceleration_penalty
